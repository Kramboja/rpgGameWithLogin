Shader "Colorify/Standard (Backfaces)"
{
	Properties
	{
		...
		_Range ("RGB Range", Range (0.0, 2.0)) = 0.01
		_HueRange ("Hue Range", Range (0.0, 4.0)) = 0.1
		_Range2 ("RGB Range 2", Range (0.0, 2.0)) = 0.01
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "ColorifyStandardCoreBackfaces.cginc"
		...
		Pass {
			...
			#include "ColorifyStandardShadow.cginc"
